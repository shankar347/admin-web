            ...
            <>
              ...
              <tbody key={index}>
                <tr>
                  ...
                  <td >{c.h1&&c.h1.length ? c.h1.map(({ room_name }) => < >{`${room_name}, `}</>) : <>Nil</>}</td>
                  <td >{c.h1&&c.h1.length}</td>
                </tr>
              </tbody>
              <tbody key={index}>
                <tr>
              ...
              <tbody key={index}>
                <tr>
                  ...
                  <td>{c.h3.length ? c.h3.map(({ room_name }) => < >{`${room_name}, `}</>) : <>Nil</>}</td>
                  <td>{c.h3.length}</td>
                </tr>
              </tbody>
              <tbody key={index}>
                <tr>
                  ...
                  <td>{c.h4.length ? c.h4.map(({ room_name }) => < >{`${room_name}, `}</>) : <>Nil</>}</td>
                  <td>{c.h4.length}</td>
                </tr>
              </tbody>
              <tbody key={index}>
                <tr>
                  ...
                  <td>{c.h5.length ? c.h5.map(({ room_name }) => < >{`${room_name}, `}</>) : <>Nil</>}</td>
                  <td>{c.h5.length}</td>
                </tr>
              </tbody>
              <tbody key={index}>
                <tr>
                  ...
                  <td>{c.h6.length ? c.h6.map(({ room_name }) => < >{`${room_name}, `}</>) : <>Nil</>}</td>
                  <td>{c.h6.length}</td>
                </tr>
              </tbody>
              <tbody key={index}>
                <tr>
                  ...
                  <td>{c.h7.length ? c.h7.map(({ room_name }) => < >{`${room_name}, `}</>) : <>Nil</>}</td>
                  <td>{c.h7.length}</td>
                </tr>
              </tbody>
              <tbody key={index}>
                <tr>
                  ...
                  <td>{c.h8.length ? c.h8.map(({ room_name }) => < >{`${room_name}, `}</>) : <>Nil</>}</td>
                  <td>{c.h8.length}</td>
                </tr>
              </tbody>
              <tbody key={index}>
                <tr>
                  ...
                  <td>{c.h9.length ? c.h9.map(({ room_name }) => < >{`${room_name}, `}</>) : <>Nil</>}</td>
                  <td>{c.h9.length}</td>
                </tr>
              </tbody>
              <tbody key={index}>
                <tr>
                  ...
                  <td>{c.h10.length ? c.h10.map(({ room_name }) => < >{`${room_name}, `}</>) : <>Nil</>}</td>
                  <td>{c.h10.length}</td>
                </tr>
              </tbody>
              <tbody key={index}>
                <tr>
                  ...
                  <td>{c.h11.length ? c.h11.map(({ room_name }) => < >{`${room_name}, `}</>) : <>Nil</>}</td>
                  <td>{c.h11.length}</td>
                </tr>
              </tbody>
              <tbody key={index}>
                <tr>
                  ...
                  <td>{c.h12.length ? c.h12.map(({ room_name }) => < >{`${room_name}, `}</>) : <>Nil</>}</td>
                  <td>{c.h12.length}</td>
                </tr>
              </tbody>
