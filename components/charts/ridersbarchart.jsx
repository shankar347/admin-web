...
const GRADIENT_COLORS = [
  { start: "#6366f1", end: "#8b5cf6" }, // Purple gradient
  { start: "#8b5cf6", end: "#a855f7" }, // Purple to violet
  { start: "#a855f7", end: "#d946ef" }, // Violet to pink
  { start: "#6366f1", end: "#4f46e5" }, // Indigo to purple
  { start: "#818cf8", end: "#6366f1" }, // Light indigo to indigo
  { start: "#a855f7", end: "#7c3aed" }, // Purple to deep purple
  { start: "#c4b5fd", end: "#8b5cf6" }, // Light purple to purple
  { start: "#8b5cf6", end: "#6366f1" }, // Purple to indigo
  { start: "#a78bfa", end: "#8b5cf6" }, // Light violet to purple
  { start: "#7c3aed", end: "#5b21b6" }, // Deep purple to darker purple
];

const CustomTooltip = ({ active, payload }) => {
  if (active && payload && payload.length) {
    const { user_id, count, stops } = payload[0].payload;
    return (
      <div
 ...
 .tooltip-scroll {
  ...
  scrollbar-color: rgba(99, 102, 241, 0.4) rgba(229, 231, 235, 0.3);
}
...
const Chatcompdash = ({ todayroutes }) => {
  ...
  const barData = useMemo(() => {
    ...
    todayroutes.forEach((route) => {
      ...
      if (!userStats[user]) {
        userStats[user] = { user_id: user, count: 0, stops: [] };
      }
      ...
      route.stops.forEach((stop) => {
        if (stop.iscompleted) {
          ...
          userStats[user].stops.push(stop.name);
        }
      });
    });
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        borderRadius: '50%',
        animation: 'float 8s ease-in-out 1'
      }} />
      ...
      >
        ...
        <div style={{
          ...
          <div style={{
            ...
            Top performers by completed stops
          </div>
        ...
        {barData.length === 0 && (
          <div style={{
            ...
            <div style={{
              ...
              Rider statistics will appear here once stops are marked as completed
            </div>
          </div>
        )}
